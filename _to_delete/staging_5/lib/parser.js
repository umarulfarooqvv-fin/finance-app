...
// Money sources that are NOT credit cards. SBI/RBL/Canara appear in the older
// history (pre-2026) as bank/other sources — treated like Fi (no card debt).
export const BANK_METHODS = ['Fi', 'Jupiter', 'Cash', 'Perks', 'SBI', 'RBL', 'Canara'];
export const SPEND_CATEGORIES = [
  'Family', 'Food', 'Fuel', 'Personal', 'Gifts/Donations',
  'Maintenance', 'Entertainment', 'Surcharge', 'Taxes',
  // Present as explicit categories in the older history:
  'Medicine', 'Groceries',
];
