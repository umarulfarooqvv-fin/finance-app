...
const DEFAULT_CARDS = [
  { name: 'Edge',        billDate: 6,  graceDays: 15, dueDay: 21, dueCycle: 'same', creditLimit: 50000,  openingBalance: 6851.68,  openingDate: '2025-12-10', color: '#7c5cff' },
  { name: 'One Card',    billDate: 22, graceDays: 16, dueDay: 8,  dueCycle: 'next', creditLimit: 115000, openingBalance: 858.57,   openingDate: '2025-12-10', color: '#2dd4bf' },
  { name: 'ICICI',       billDate: 5,  graceDays: 18, dueDay: 23, dueCycle: 'same', creditLimit: 50000,  openingBalance: 5433.13,  openingDate: '2025-12-10', color: '#f97316' },
  { name: 'Coral',       billDate: 25, graceDays: 17, dueDay: 12, dueCycle: 'next', creditLimit: 50000,  openingBalance: 2662.72,  openingDate: '2025-12-15', color: '#ef4444' },
  { name: 'Scapia',      billDate: 14, graceDays: 19, dueDay: 3,  dueCycle: 'next', creditLimit: 48000,  openingBalance: 16951.5,  openingDate: '2026-01-04', color: '#38bdf8' },
  { name: 'Super Money', billDate: 1,  graceDays: 14, dueDay: 15, dueCycle: 'same', creditLimit: 2452.5, openingBalance: 0,        openingDate: '2025-12-10', color: '#facc15' },
];
...
export function getDb() {
  ...
  if (hcount === 0) {
    ...
    for (const h of [
      { id: 'seed-savings', kind: 'savings', name: 'Savings (all jars)', institution: 'Fi', invested: 34833, current_value: 34833, target: 0, note: 'Aggregate of Savings tab streams — split as needed', updated_at: seedAt },
      { id: 'seed-invest-gold', kind: 'investment', name: 'Gold (Jupiter)', institution: 'Jupiter', invested: 4239.15, current_value: 5605.78, target: 0, note: 'From Investment tab — 0.3849 g', updated_at: seedAt },
      { id: 'seed-invest-rest', kind: 'investment', name: 'FD + Rewards + other', institution: null, invested: 70240.24, current_value: 81421.13, target: 0, note: 'Investment tab total minus gold — verify', updated_at: seedAt },
    ]) ins.run(h);
  }
  return db;
}
