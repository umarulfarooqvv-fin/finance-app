...
const I = {
  ...
  insights: (
    ...
    >
      ...
      <path d="M22 12h-4" />
      <path d="M8.5 20a3.5 3.5 0 1 1 7 0z" />
      <path d="M12 13v3" />
    </svg>
  ),
  expenses: (
  ...
  debt: (
    ...
    >
      ...
      <path d="M3 21l8-8" />
      <path d="M16 3h5v5" />
      <path d="M5 8a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H7" />
    </svg>
  ),
  savings: (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M19 10c1 0 2 .9 2 2v2h-2.2a7 7 0 0 1-2.3 3.2V20h-3v-1.5h-3V20h-3v-2.8C5.6 15.9 4.5 14 4.5 12A7.5 7.5 0 0 1 12 4.5c3.5 0 6.4 2.3 7 5.5z" />
...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      ['/credit-taken', 'Credit Taken', 'debt'],
...
export default function Nav() {
  ...
  const themeBtn = (
    ...
    >
      <span className="navic" style={{ verticalAlign: '-3px' }}>
  ...
  const syncBtn = (
    ...
    >
      <span className="navic" style={{ verticalAlign: '-3px', marginRight: 5 }}>
        {I.sync}
      </span>
    ...
    <>
      ...
      <aside className="sidebar">
        <Link href="/" className="brand">
          <span className="brandmark">₹</span> Finance
        </Link>
        {GROUPS.map((g) => (
          <div className="navgroup" key={g.label}>
            ...
            {g.items.map(([href, label, ic]) => (
              <Link key={href} href={href} className={`navitem ${path === href ? 'active' : ''}`}>
                <span className="navic">{I[ic]}</span>
                {label}
              </Link>
            ))}
          </div>
